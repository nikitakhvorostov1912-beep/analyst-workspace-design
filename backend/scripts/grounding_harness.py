...
SYSTEM = (
    ...
    "Загружена типовая «Управление Торговлей 11.5», её channel_id = \"_bench\". "
    "Используй РОВНО этот channel_id во всех вызовах trace_*/explain_*/search_*. "
    "НЕ вызывай list_typical_configurations — канал уже известен. "
    "Имена объектов в форме «Document.X», «AccumulationRegister.Y», «Catalog.Z». "
