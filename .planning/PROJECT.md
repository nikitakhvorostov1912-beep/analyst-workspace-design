...
> ⚠️ **Базовый GSD-документ (init-эра, 2026-05-13).** Есть дубль в корне (`/PROJECT.md`).
> Актуальная концепция — корневой `CLAUDE.md` + `.planning/ROADMAP-2026-05-29.md`.
> Карта проекта — `/PROJECT-INDEX.md`. Этот файл — исторический контекст.
