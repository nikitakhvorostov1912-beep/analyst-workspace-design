...
const EXAMPLE_QUESTIONS = [
  "Покажи список метаданных базы",
  "Сколько документов реализации за май 2026",
  "Найди контрагента с ИНН 7707083893",
  "Покажи 10 последних ошибок из журнала регистрации",
] as const;
      ...
      <div className="max-w-xl w-full text-center space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-sm text-[var(--fg-3)] leading-relaxed">
            Напиши вопрос на русском в поле ниже. Модель сама подберёт нужные
            инструменты 1С, выполнит запросы и покажет ответ.
          </p>
        </div>
